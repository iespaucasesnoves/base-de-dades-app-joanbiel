...
public class HelperVi extends SQLiteOpenHelper {
    ...
    public static final
    String
            COLUMN__IDDENOMINACIO
            =
            "_iddenominacio";
    public static final
    String
            COLUMN_NOMDENOMINACIO
            =
            "nomdenominacio";
    public static final
    String
    ...
    private static final int
            DATABASE_VERSION
            =
            1;      // Controla la versió de la base de dades
    ...
    onUpgrade(SQLiteDatabase db,
              ...
              int
                      newVersion) {
        // Detecta si hi ha una canvi a
        DATABASE_VERSION
        i recrea la base de dades
        Log.
                w
                        (HelperVi.
                                        class
                                        .getName(),
                                "Modificant desde la versió "
                                        + oldVersion +
                                        " a "
                                        + newVersion);
        db.execSQL(
